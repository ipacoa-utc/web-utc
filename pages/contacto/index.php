  ...
  <body>
    ...
    <div class="page text-center">
                ...
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-mobile-scroll">
                    ...
                    <ul class="rd-navbar-nav">
                      <li><a href="index.html"><span>Home</span><span class="rd-navbar-label text-middle label-custom label-danger label-xs-custom label-rounded-custom label">new</span></a>
                        <ul class="rd-navbar-dropdown">
                          <li><a href="#"><span class="text-middle">Child Themes</span></a>
                            <ul class="rd-navbar-dropdown">
                              <li><a href="intense-photographer-portfolio/index.html"><span class="text-middle">Photographer</span></a>
                              </li>
                              <li><a href="intense-restaurant/index.html"><span class="text-middle">Restaurant</span></a>
                              </li>
                              <li><a href="intense-personal-blog/index.html"><span class="text-middle">Personal Blog</span></a>
                              </li>
                              <li><a href="intense-real-estate/index.html"><span class="text-middle">Real Estate</span></a>
                              </li>
                              <li><a href="intense-handmade/index.html"><span class="text-middle">Handmade</span></a>
                              </li>
                              <li><a href="intense-dental-clinic/index.html"><span class="text-middle">Dental Clinic</span></a>
                              </li>
                              <li><a href="intense-financial-analytic/index.html"><span class="text-middle">Financial Advisor</span></a>
                              </li>
                              <li><a href="intense-gym/index.html"><span class="text-middle">Gym</span></a>
                              </li>
                              <li><a href="intense-child-care/index.html"><span class="text-middle">Child Care</span></a>
                              </li>
                              <li><a href="intense-job-board/index.html"><span class="text-middle">Job Board</span></a>
                              </li>
                              <li><a href="newsletter/responsive/index.html"><span class="text-middle">Newsletter</span></a>
                              </li>
                              <li><a href="intense-taxi/index.html"><span class="text-middle">Taxi</span></a>
                              </li>
                              <li><a href="intense-pet-shop/index.html"><span class="text-middle">Pet shop</span></a>
                              </li>
                              <li><a href="intense-barbershop/index.html"><span class="text-middle">Barbershop</span></a>
                              </li>
                            </ul>
                          </li>
                          ...
                          <li><a href="#"><span class="text-middle">Landing pages</span><span class="rd-navbar-label label-custom label-danger label-xs-custom label-rounded-custom label">new</span></a>
                            <ul class="rd-navbar-dropdown">
                              <li><a href="intense-landings/intense-application/index.html"><span class="text-middle">Application</span></a>
                              </li>
                              <li><a href="intense-landings/intense-book/index.html"><span class="text-middle">Book</span></a>
                              </li>
                              <li><a href="intense-landings/intense-product/index.html"><span class="text-middle">Product</span></a>
                              </li>
                              <li><a href="intense-landings/intense-travel/index.html"><span class="text-middle">Travel</span></a>
                              </li>
                              <li><a href="intense-landings/intense-startup/index.html"><span class="text-middle">Startup</span></a>
                              </li>
                              <li><a href="intense-landings/intense-event/index.html"><span class="text-middle">Event</span></a>
                              </li>
                              <li><a href="intense-landings/landing-agency/index.html"><span class="text-middle">Agency</span><span class="rd-navbar-label label-custom label-danger label-xs-custom label-rounded-custom label">new</span></a>
                              </li>
                              <li><a href="intense-landings/landing-business/index.html"><span class="text-middle">Business</span><span class="rd-navbar-label label-custom label-danger label-xs-custom label-rounded-custom label">new</span></a>
                              </li>
                              <li><a href="intense-landings/landing-corporate/index.html"><span class="text-middle">Corporate</span><span class="rd-navbar-label label-custom label-danger label-xs-custom label-rounded-custom label">new</span></a>
                              </li>
                              <li><a href="intense-landings/landing-personal/index.html"><span class="text-middle">Personal</span><span class="rd-navbar-label label-custom label-danger label-xs-custom label-rounded-custom label">new</span></a>
                              </li>
                              <li><a href="intense-landings/landing-shop/index.html"><span class="text-middle">Shop</span><span class="rd-navbar-label label-custom label-danger label-xs-custom label-rounded-custom label">new</span></a>
                              </li>
                              <li><a href="intense-landings/landing-startup/index.html"><span class="text-middle">Startup</span><span class="rd-navbar-label label-custom label-danger label-xs-custom label-rounded-custom label">new</span></a>
                              </li>
                            </ul>
                          </li>
                        </ul>
                      </li>
                      <li class="active"><a href="#"><span>Features</span><span class="rd-navbar-label text-middle label-custom label-danger label-xs-custom label-rounded-custom label">new</span></a>
                        <ul class="rd-navbar-dropdown">
                          ...
                          <li><a href="subscribe.html"><span class="text-middle">Mailchimp &amp; Campaign Monitor</span><span class="rd-navbar-label label-custom label-danger label-xs-custom label-rounded-custom label">new</span></a>
                          </li>
                        ...
                        <div class="rd-navbar-megamenu">
                          <div class="row">
                            ...
                            <ul class="col-lg-3">
                              ...
                              <li><a href="subscribe.html"><span class="rd-navbar-icon mdi mdi-email-outline"></span><span class="text-middle">Subscribe</span></a></li>
                            ...
                            <ul class="col-lg-3">
                              ...
                              <li><a href="under-constraction.html"><span class="rd-navbar-icon mdi mdi-worker"></span><span class="text-middle">Under Construction</span></a></li>
      ...
      <main class="page-content">
        <!-- Complete integration with Charts and Graphs-->
        <div class="parallax-container bg-gray-base context-dark" data-parallax-img="images/backgrounds/background-50-1920x1200.jpg">
                  ...
                  <div class="range">
                    <div class="range range-xs-middle range-xs-center section-cover section-110">
                      <div class="cell-xs-12">
                        <div>
                          <h1><span class="big">reCAPTCHA</span></h1>
                        </div>
                        <div class="range range-xs-center offset-top-0">
                          <div class="cell-md-8">
                            <div class="offset-top-20">
                              <h4 class="text-light">Say no to spam messages with integrated Google Recapture tool. Now you can simply enable message filtering with one of the most effective spam filters so far and say good bye forever to unsolicited emails.</h4>
                            </div>
                          </div>
                        </div>
                        <div class="range range-xs-center offset-top-20 offset-xs-top-41 offset-md-top-66">
                          <div class="cell-xs-5 cell-sm-4 cell-md-3 text-sm-right inset-sm-left-50"><a class="btn btn-block btn-primary" href="//documentation.zemez.io/html/bootstrap/intense/">buy intense now</a></div>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <footer class="section-relative section-top-66 section-bottom-34 page-footer bg-gray-base context-dark">
        ...
        <div class="shell offset-top-50">
          <p class="small text-darker">Intense &copy; <span class="copyright-year"></span> . <a href="privacy.html">Privacy Policy</a></p>
        </div>
      </footer>
    </div>
